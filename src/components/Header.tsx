    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-4">
        <nav className="flex items-center justify-between">
          ...
          {/* Mobile menu button */}
          <button className="md:hidden relative z-20" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            <div className="space-y-2">
              <span className="block w-8 h-0.5 bg-[#00FFD1]"></span>
              <span className="block w-8 h-0.5 bg-[#00FFD1]"></span>
              <span className="block w-8 h-0.5 bg-[#00FFD1]"></span>
            </div>
          </button>
          ...
          <AnimatePresence>
            {mobileMenuOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className="absolute top-0 left-0 right-0 bg-black/95 backdrop-blur-lg p-6 pt-24 space-y-4 shadow-lg md:hidden"
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-4 justify-center pt-4">
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#00FFD1]/70 hover:text-[#00FFD1] transition-colors p-2"
                      whileTap={{ scale: 0.95 }}
                    >
